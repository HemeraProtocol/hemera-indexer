...
from models.bridge.arbitrum.arbitrum_bridge_parser import ArbitrumBridgeExtractor
from models.tests.json_rpc_to_dataclass import get_transaction_from_rpc
