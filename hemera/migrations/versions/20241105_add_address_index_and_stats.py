...
Revision ID: 3bd2e3099bae
Revises: bc23aa19668e
Create Date: 2024-11-05 14:40:03.570136
...
def upgrade() -> None:
    ...
    op.drop_table("daily_contract_interacted_aggregates", if_exists=True)
    op.drop_table("scheduled_token_count_metadata", if_exists=True)
    op.drop_table("daily_addresses_aggregates", if_exists=True)
    op.drop_table("daily_transactions_aggregates", if_exists=True)
    op.drop_table("scheduled_wallet_count_metadata", if_exists=True)
    op.drop_table("daily_wallet_addresses_aggregates", if_exists=True)
    op.drop_table("statistics_wallet_addresses", if_exists=True)
    op.drop_table("daily_tokens_aggregates", if_exists=True)
    op.drop_table("daily_blocks_aggregates", if_exists=True)
...
def downgrade() -> None:
    ...
    op.drop_table("coin_prices", if_exists=True)
    op.drop_table("af_stats_na_daily_transactions", if_exists=True)
    op.drop_table("af_stats_na_daily_tokens", if_exists=True)
    op.drop_table("af_stats_na_daily_bridge_transactions", if_exists=True)
    op.drop_table("af_stats_na_daily_blocks", if_exists=True)
    op.drop_table("af_stats_na_daily_addresses", if_exists=True)
    op.drop_table("af_index_token_address_stats", if_exists=True)
    op.drop_table("af_index_token_address_daily_stats", if_exists=True)
    op.drop_table("af_index_stats", if_exists=True)
    op.drop_table("af_index_na_scheduled_metadata", if_exists=True)
    op.drop_table("af_index_daily_stats", if_exists=True)
    op.drop_index(
        "feature_erc1155_token_holding_token_wallet_block_desc_index",
        table_name="af_erc1155_token_holdings_hist",
        if_exists=True,
    )
    op.drop_index(
        "feature_erc1155_token_holding_token_block_desc_index",
    ...
    op.drop_table("af_erc1155_token_holdings_hist", if_exists=True)
    op.drop_index(
        "af_erc1155_token_holdings_current_wallet_block_desc_index",
        table_name="af_erc1155_token_holdings_current",
        if_exists=True,
    )
    op.drop_index(
        "af_erc1155_token_holdings_current_token_block_desc_index",
