...
from hemera.indexer.modules.bridge.bedrock.parser.bedrock_bridge_parser import (
    parse_message_passed_event,
    parse_transaction_deposited_event,
)
from hemera.indexer.modules.bridge.bedrock.parser.function_parser import BedRockFunctionCallType
from hemera.indexer.tests.json_rpc_to_dataclass import get_transaction_from_rpc
