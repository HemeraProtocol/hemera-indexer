...
class AgniV3PoolJob(FilterTransactionDataJob):
    ...
    @staticmethod
    def create_current_price_status(detail: AgniV3PoolPrice) -> AgniV3PoolCurrentPrice:
        return AgniV3PoolCurrentPrice(**{field.name: getattr(detail, field.name) for field in fields(AgniV3PoolPrice)})
