...
from indexer.modules.custom.uniswap_v3.domains.feature_uniswap_v3 import (
    ...
    UniswapV3PoolPrice,
    UniswapV3SwapEvent, UniswapV3Pool,
)
...
from indexer.modules.custom.uniswap_v3.swapsicle_abi import (
    SWAP_EVENT as SICLE_SWAP_EVENT,
)
from indexer.modules.custom.uniswap_v3.agni_abi import (
    SWAP_EVENT as AGNI_SWAP_EVENT,
)
...
class ExportUniSwapV3PoolJob(FilterTransactionDataJob):
        ...
        return TransactionFilterByLogs(
            [
                TopicSpecification(
                    ...
                    ], addresses=['0x42b67d7e60861f8caa472a89ae567bd4f9180ac5']
                ),
            ]
        )
        ...
        for transaction in transactions:
            ...
            for log in logs:
                if log.address in self._exist_pools:
                    ...
                    if log.topic0 == SICLE_SWAP_EVENT.get_signature():
    ...
    def get_uniswap_v3_pool_price_and_swap_event(self, **kwargs):
        pass
    ...
    def get_existing_pools(self):
        ...
        try:
            ...
            existing_pools = {bytes_to_hex_str(p.pool_address): {
