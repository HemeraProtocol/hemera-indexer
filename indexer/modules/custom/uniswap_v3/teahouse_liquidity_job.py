...
from indexer.modules.custom.uniswap_v3.domains.feature_uniswap_v3 import TeahouseLiquidityHist, TeahouseLiquidityCurrent
from indexer.modules.custom.uniswap_v3.teahouse_abi import GET_ALL_POSITIONS_FUNCTION
...
class TeahouseLiquidityJob(FilterTransactionDataJob):
    ...
    def _process(self, **kwargs):
        ...
        current_list = self.extract_current_status(records, TeahouseLiquidityCurrent, ["position_token_address", "pool_address"])
