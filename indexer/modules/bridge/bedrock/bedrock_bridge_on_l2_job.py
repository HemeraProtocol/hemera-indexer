...
from indexer.modules.bridge.bedrock.parser.bedrock_bridge_parser import parse_relayed_message, \
    BEDROCK_EVENT_ABI_SIGNATURE_MAPPING, parse_message_passed_event
...
class BedrockBridgeOnL2Job(FilterTransactionDataJob):
    ...
    def __init__(self, **kwargs):
        ...
        assert self._l2_to_l1_message_passer and self._l2_cross_domain_messenger, "Both l2_to_l1_message_passer and l2_cross_domain_messenger must be provided."
    ...
    def get_filter(self):
        ...
        return TransactionFilterByLogs([
            TopicSpecification(addresses=addresses, topics=topics)
        ])
