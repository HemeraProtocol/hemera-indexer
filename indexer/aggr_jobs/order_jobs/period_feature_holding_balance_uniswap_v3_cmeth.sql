delete
from period_feature_holding_balance_uniswap_v3_cmeth
...
insert
into period_feature_holding_balance_uniswap_v3_cmeth(protocol_id,
                                                    contract_address,
                                                    period_date,
                                                    token_id,
                                                    wallet_address,
...
SELECT CASE
           ...
           WHEN nft_address = '\x46a15b0b27311cedf172ab29e4f4766fbe7f4364' then 'pancake'
           WHEN nft_address = '\x7d24de60a68ae47be4e852cf03dd4d8588b489ec' then 'swapsicle'
           ELSE 'uniswap_v3'
           END AS protocol_id,
       pool_address,
       period_date,
