...
class DailyFeatureUniswapV3AggregatesJob(AggrBaseJob):
    sql_folder = "daily_feature_uniswap_v3_aggregates_job"
    ...
    def run(self, **kwargs):
        ...
        for date_pair in date_pairs:
            ...
            sql_content = self.get_sql_content("daily_feature_uniswap_v3_aggregates", start_date, end_date)
