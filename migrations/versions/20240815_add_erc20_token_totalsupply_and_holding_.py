...
def upgrade() -> None:
    ...
    op.create_table('feature_erc20_token_holding',
    ...
    sa.PrimaryKeyConstraint('token_address', 'wallet_address', 'called_block_number', 'called_block_timestamp')
    )
    op.create_index('feature_erc20_token_holding_token_block_desc_index', 'feature_erc20_token_holding', [sa.text('token_address DESC'), sa.text('called_block_timestamp DESC')], unique=False)
    op.create_index('feature_erc20_token_holding_token_wallet_block_desc_index', 'feature_erc20_token_holding', [sa.text('token_address DESC'), sa.text('wallet_address DESC'), sa.text('called_block_number DESC')], unique=False)
    op.create_table('feature_erc20_total_supply',
    sa.Column('token_address', postgresql.BYTEA(), nullable=False),
    sa.Column('called_block_number', sa.BIGINT(), nullable=False),
    sa.Column('called_block_timestamp', sa.BIGINT(), nullable=False),
    ...
    sa.Column('create_time', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('update_time', postgresql.TIMESTAMP(), nullable=True),
    sa.PrimaryKeyConstraint('token_address', 'called_block_number', 'called_block_timestamp')
    )
