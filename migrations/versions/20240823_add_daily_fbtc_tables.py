...
Revision ID: ab742091bb31
Revises: 8ed65fe65ee5
Create Date: 2024-08-23 11:38:04.083826
...
def upgrade() -> None:
    ...
    op.add_column(
        "daily_wallet_addresses_aggregates", sa.Column("token_balance", sa.NUMERIC(precision=78), nullable=True)
    )
    op.create_index(
    ...
    op.add_column(
        "period_wallet_addresses_aggregates", sa.Column("token_balance", sa.NUMERIC(precision=78), nullable=True)
    )
    op.create_index(
