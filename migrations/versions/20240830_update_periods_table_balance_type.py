...
def upgrade() -> None:
    ...
    op.alter_column('daily_feature_holding_balance_dodo', 'balance_of',
               existing_type=sa.NUMERIC(precision=78, scale=0),
               type_=sa.NUMERIC(precision=100, scale=18),
               existing_nullable=True)
    op.alter_column('daily_feature_holding_balance_dodo', 'total_supply',
               existing_type=sa.NUMERIC(precision=78, scale=0),
               type_=sa.NUMERIC(precision=100, scale=18),
               existing_nullable=True)
    op.alter_column('daily_feature_holding_balance_dodo', 'token0_balance',
               existing_type=sa.NUMERIC(precision=78, scale=0),
               type_=sa.NUMERIC(precision=100, scale=18),
               existing_nullable=True)
    op.alter_column('daily_feature_holding_balance_dodo', 'token1_balance',
               existing_type=sa.NUMERIC(precision=78, scale=0),
               type_=sa.NUMERIC(precision=100, scale=18),
               existing_nullable=True)
