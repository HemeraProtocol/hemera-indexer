...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('feature_uniswap_v3_tokens', sa.Column('mint_block_number', sa.BIGINT(), autoincrement=False, nullable=True))
    op.drop_column('feature_uniswap_v3_tokens', 'called_block_number')
    op.add_column('feature_uniswap_v3_pools', sa.Column('mint_block_number', sa.BIGINT(), autoincrement=False, nullable=True))
