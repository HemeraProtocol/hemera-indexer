...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('transactions_test',
    ...
    sa.Column('receipt_cumulative_gas_used', sa.NUMERIC(precision=100, scale=0), autoincrement=False, nullable=True),
    sa.Column('receipt_effective_gas_price', sa.NUMERIC(precision=100, scale=0), autoincrement=False, nullable=True),
    ...
    sa.Column('method_id', sa.VARCHAR(), sa.Computed('substr(((input)::character varying)::text, 3, 8)', persisted=True), autoincrement=False, nullable=True),
