...
def upgrade() -> None:
    ...
    op.create_table('af_eigen_layer_address_current',
    ...
    op.create_table('af_eigen_layer_records',
    ...
    op.create_table('af_erc20_total_supply_current',
    ...
    op.create_table('af_erc20_total_supply_hist',
    sa.Column('token_address', postgresql.BYTEA(), nullable=False),
    ...
    op.create_table('af_ether_fi_lrt_exchange_rate',
    sa.Column('token_address', postgresql.BYTEA(), nullable=False),
    ...
    op.create_table('af_ether_fi_position_values',
    sa.Column('block_number', sa.BIGINT(), nullable=False),
    ...
    op.create_table('af_ether_fi_share_balances',
    sa.Column('address', postgresql.BYTEA(), nullable=False),
    sa.Column('token_address', postgresql.BYTEA(), nullable=False),
    sa.Column('shares', sa.NUMERIC(precision=100), nullable=True),
    sa.Column('block_number', sa.BIGINT(), nullable=False),
    ...
    op.create_table('af_ether_fi_share_balances_current',
    sa.Column('address', postgresql.BYTEA(), nullable=False),
    sa.Column('token_address', postgresql.BYTEA(), nullable=False),
    sa.Column('shares', sa.NUMERIC(precision=100), nullable=True),
    sa.Column('block_number', sa.BIGINT(), nullable=True),
    ...
    op.create_table('af_karak_address_current',
    sa.Column('address', postgresql.BYTEA(), nullable=False),
    ...
    op.create_table('af_karak_records',
    sa.Column('transaction_hash', postgresql.BYTEA(), nullable=False),
    sa.Column('log_index', sa.INTEGER(), nullable=False),
    sa.Column('block_number', sa.BIGINT(), nullable=True),
    sa.Column('block_timestamp', postgresql.TIMESTAMP(), nullable=True),
    ...
    op.create_table('af_karak_vault_token',
    sa.Column('vault', postgresql.BYTEA(), nullable=False),
    ...
    op.create_table('af_lido_position_values',
    sa.Column('block_number', sa.BIGINT(), nullable=False),
    sa.Column('total_share', sa.NUMERIC(precision=100), nullable=True),
    ...
    op.create_table('af_lido_seth_share_balances',
    sa.Column('address', postgresql.BYTEA(), nullable=False),
    sa.Column('token_address', postgresql.BYTEA(), nullable=False),
    sa.Column('shares', sa.NUMERIC(precision=100), nullable=True),
    sa.Column('block_number', sa.BIGINT(), nullable=False),
    ...
    op.create_table('af_lido_seth_share_balances_current',
    sa.Column('address', postgresql.BYTEA(), nullable=False),
    sa.Column('token_address', postgresql.BYTEA(), nullable=False),
    sa.Column('shares', sa.NUMERIC(precision=100), nullable=True),
    sa.Column('block_number', sa.BIGINT(), nullable=True),
    ...
    op.create_table('af_pendle_pool',
    ...
    op.create_table('af_pendle_user_active_balance',
    sa.Column('market_address', postgresql.BYTEA(), nullable=False),
    ...
    op.create_table('af_pendle_user_active_balance_current',
    sa.Column('market_address', postgresql.BYTEA(), nullable=False),
    sa.Column('user_address', postgresql.BYTEA(), nullable=False),
    sa.Column('sy_balance', sa.NUMERIC(precision=100), nullable=True),
    sa.Column('active_balance', sa.NUMERIC(precision=100), nullable=True),
    ...
    op.create_table('af_project_contracts',
    ...
    op.create_table('af_staked_transferred_balance_current',
    ...
    sa.Column('update_time', postgresql.TIMESTAMP(), server_default=sa.text('now()'), nullable=True),
    sa.Column('reorg', sa.BOOLEAN(), nullable=True),
    sa.PrimaryKeyConstraint('contract_address', 'wallet_address', 'token_address', 'block_timestamp', 'block_number'),
    if_not_exists=True
    )
    op.create_table('af_staked_transferred_balance_hist',
    sa.Column('contract_address', postgresql.BYTEA(), nullable=False),
    sa.Column('token_address', postgresql.BYTEA(), nullable=False),
    sa.Column('wallet_address', postgresql.BYTEA(), nullable=False),
    sa.Column('block_number', sa.BIGINT(), nullable=False),
    ...
    op.create_table('af_uniswap_v2_pools',
    ...
    op.create_table('cyber_id_record',
    ...
    op.create_table('init_capital_pool_current',
    sa.Column('pool_address', postgresql.BYTEA(), nullable=False),
    ...
    op.create_table('init_capital_pool_history',
    sa.Column('pool_address', postgresql.BYTEA(), nullable=False),
    sa.Column('token_address', postgresql.BYTEA(), nullable=True),
    sa.Column('total_asset', sa.NUMERIC(precision=100), nullable=True),
    sa.Column('total_supply', sa.NUMERIC(precision=100), nullable=True),
    ...
    op.create_table('init_capital_position_current',
    ...
    op.create_table('init_capital_position_history',
    sa.Column('position_id', sa.NUMERIC(precision=100), nullable=False),
    sa.Column('owner_address', postgresql.BYTEA(), nullable=True),
    sa.Column('viewer_address', postgresql.BYTEA(), nullable=True),
    sa.Column('mode', sa.INTEGER(), nullable=True),
    ...
    op.create_table('init_capital_record',
    ...
    op.alter_column('address_nft_transfers', 'transaction_hash',
               existing_type=postgresql.BYTEA(),
               nullable=False)
    op.alter_column('address_token_transfers', 'transaction_hash',
               existing_type=postgresql.BYTEA(),
               nullable=False)
    ...
    op.alter_column('erc721_token_mint', 'transaction_hash',
               existing_type=postgresql.BYTEA(),
               nullable=True)
    op.create_index('erc721_token_mint_address_id_index', 'erc721_token_mint', ['token_address', 'token_id'], unique=False, if_not_exists=True)
...
def downgrade() -> None:
    ...
    op.add_column('af_holding_balance_uniswap_v3_period', sa.Column('position_token_address', postgresql.BYTEA(), autoincrement=False, nullable=False))
    ...
    op.alter_column('address_nft_transfers', 'transaction_hash',
               existing_type=postgresql.BYTEA(),
               nullable=True)
    op.create_table('feature_uniswap_v2_pools',
    ...
    op.create_table('scheduled_metadata',
