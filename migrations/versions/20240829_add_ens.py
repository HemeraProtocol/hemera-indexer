...
Revision ID: 3a9e194bcdde
Revises: bf51d23c852f
Create Date: 2024-08-29 13:52:45.938764
...
def upgrade() -> None:
    ...
    op.create_index('ens_idx_reverse_name', 'ens_record', ['reverse_name'], unique=False)
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('ens_idx_reverse_name', table_name='ens_record')
