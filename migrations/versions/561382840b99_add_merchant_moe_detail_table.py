...
Revision ID: 561382840b99
Revises: 2961c81d0b50
Create Date: 2024-08-16 15:41:01.018941
...
def upgrade() -> None:
    ...
    op.create_index('feature_erc1155_token_supply_token_block_desc_index', 'feature_merchant_moe_token_bin_records', [sa.text('token_address DESC'), sa.text('called_block_timestamp DESC')], unique=False)
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('feature_erc1155_token_supply_token_block_desc_index', table_name='feature_merchant_moe_token_bin_records')
