...
def upgrade() -> None:
    ...
    op.create_table('address_current_token_balances',
    ...
    op.create_index('current_token_balances_token_address_balance_of_index', 'address_current_token_balances', ['token_address', sa.text('balance DESC')], unique=False)
    op.create_index('current_token_balances_token_address_id_balance_of_index', 'address_current_token_balances', ['token_address', 'token_id', sa.text('balance DESC')], unique=False)
    ...
    op.create_index('coin_balance_address_number_desc_index', 'address_coin_balances', [sa.text('address DESC'), sa.text('block_number DESC')], unique=False)
    op.create_index('token_balance_address_id_number_index', 'address_token_balances', ['address', 'token_address', sa.text('token_id DESC'), sa.text('block_number DESC')], unique=False)
    ...
    op.create_index('blocks_hash_unique_when_not_reorg', 'blocks', ['hash'], unique=True, postgresql_where=sa.text('reorg = false'))
    op.create_index('blocks_number_unique_when_not_reorg', 'blocks', ['number'], unique=True, postgresql_where=sa.text('reorg = false'))
    ...
    op.create_index('internal_transactions_block_number_index', 'contract_internal_transactions', [sa.text('block_number DESC')], unique=False)
    ...
    op.alter_column('erc1155_token_transfers', 'token_id',
               ...
               nullable=False)
    op.alter_column('erc1155_token_transfers', 'block_hash',
    ...
    op.create_index('erc1155_token_transfers_from_address_number_log_index_index', 'erc1155_token_transfers', ['from_address', sa.text('block_number DESC'), sa.text('log_index DESC')], unique=False)
    op.create_index('erc1155_token_transfers_number_log_index', 'erc1155_token_transfers', [sa.text('block_number DESC'), sa.text('log_index DESC')], unique=False)
    op.create_index('erc1155_token_transfers_to_address_number_log_index_index', 'erc1155_token_transfers', ['to_address', sa.text('block_number DESC'), sa.text('log_index DESC')], unique=False)
    op.create_index('erc1155_token_transfers_token_address_from_index', 'erc1155_token_transfers', ['token_address', 'from_address'], unique=False)
    op.create_index('erc1155_token_transfers_token_address_id_index', 'erc1155_token_transfers', ['token_address', 'token_id'], unique=False)
    op.create_index('erc1155_token_transfers_token_address_number_log_index_index', 'erc1155_token_transfers', ['token_address', sa.text('block_number DESC'), sa.text('log_index DESC')], unique=False)
    op.create_index('erc1155_token_transfers_token_address_to_index', 'erc1155_token_transfers', ['token_address', 'to_address'], unique=False)
    op.alter_column('erc20_token_transfers', 'block_hash',
               existing_type=postgresql.BYTEA(),
               nullable=False)
    ...
    op.create_index('erc20_token_transfers_from_address_number_log_index_index', 'erc20_token_transfers', ['from_address', sa.text('block_number DESC'), sa.text('log_index DESC')], unique=False)
    op.create_index('erc20_token_transfers_number_log_index', 'erc20_token_transfers', [sa.text('block_number DESC'), sa.text('log_index DESC')], unique=False)
    op.create_index('erc20_token_transfers_to_address_number_log_index_index', 'erc20_token_transfers', ['to_address', sa.text('block_number DESC'), sa.text('log_index DESC')], unique=False)
    ...
    op.create_index('erc721_token_transfers_from_address_number_log_index_index', 'erc721_token_transfers', ['from_address', sa.text('block_number DESC'), sa.text('log_index DESC')], unique=False)
    op.create_index('erc721_token_transfers_number_log_index', 'erc721_token_transfers', [sa.text('block_number DESC'), sa.text('log_index DESC')], unique=False)
    op.create_index('erc721_token_transfers_to_address_number_log_index_index', 'erc721_token_transfers', ['to_address', sa.text('block_number DESC'), sa.text('log_index DESC')], unique=False)
    op.create_index('erc721_token_transfers_token_address_from_index', 'erc721_token_transfers', ['token_address', 'from_address'], unique=False)
    op.create_index('erc721_token_transfers_token_address_id_index', 'erc721_token_transfers', ['token_address', 'token_id'], unique=False)
    op.create_index('erc721_token_transfers_token_address_number_log_index_index', 'erc721_token_transfers', ['token_address', sa.text('block_number DESC'), sa.text('log_index DESC')], unique=False)
    op.create_index('erc721_token_transfers_token_address_to_index', 'erc721_token_transfers', ['token_address', 'to_address'], unique=False)
    op.drop_column('erc721_token_transfers', 'token_uri')
    op.alter_column('logs', 'block_hash',
               existing_type=postgresql.BYTEA(),
               nullable=False)
    op.create_index('logs_address_topic_0_number_log_index_index', 'logs', ['address', 'topic0', sa.text('block_number DESC'), sa.text('log_index DESC')], unique=False)
    op.create_index('logs_block_number_log_index_index', 'logs', [sa.text('block_number DESC'), sa.text('log_index DESC')], unique=False)
    op.create_index('tokens_name_index', 'tokens', ['name'], unique=False)
    op.create_index('tokens_type_holders_index', 'tokens', ['token_type', sa.text('holder_count DESC')], unique=False)
    op.create_index('tokens_type_on_chain_market_cap_index', 'tokens', ['token_type', sa.text('on_chain_market_cap DESC')], unique=False)
    ...
    op.create_index('transactions_block_timestamp_index', 'transactions', ['block_timestamp'], unique=False)
    op.create_index('transactions_from_address_block_number_transaction_idx', 'transactions', [sa.text('from_address ASC'), sa.text('block_number DESC'), sa.text('transaction_index DESC')], unique=False)
    op.create_index('transactions_to_address_block_number_transaction_idx', 'transactions', [sa.text('to_address ASC'), sa.text('block_number DESC'), sa.text('transaction_index DESC')], unique=False)
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('transactions_to_address_block_number_transaction_idx', table_name='transactions')
    op.drop_index('transactions_from_address_block_number_transaction_idx', table_name='transactions')
    ...
    op.drop_index('erc721_token_transfers_token_address_to_index', table_name='erc721_token_transfers')
    op.drop_index('erc721_token_transfers_token_address_number_log_index_index', table_name='erc721_token_transfers')
    op.drop_index('erc721_token_transfers_token_address_id_index', table_name='erc721_token_transfers')
    op.drop_index('erc721_token_transfers_token_address_from_index', table_name='erc721_token_transfers')
    op.drop_index('erc721_token_transfers_to_address_number_log_index_index', table_name='erc721_token_transfers')
    op.drop_index('erc721_token_transfers_number_log_index', table_name='erc721_token_transfers')
    op.drop_index('erc721_token_transfers_from_address_number_log_index_index', table_name='erc721_token_transfers')
    ...
    op.drop_index('erc20_token_transfers_to_address_number_log_index_index', table_name='erc20_token_transfers')
    op.drop_index('erc20_token_transfers_number_log_index', table_name='erc20_token_transfers')
    op.drop_index('erc20_token_transfers_from_address_number_log_index_index', table_name='erc20_token_transfers')
    ...
    op.alter_column('erc20_token_transfers', 'block_hash',
               existing_type=postgresql.BYTEA(),
               nullable=True)
    op.drop_index('erc1155_token_transfers_token_address_to_index', table_name='erc1155_token_transfers')
    op.drop_index('erc1155_token_transfers_token_address_number_log_index_index', table_name='erc1155_token_transfers')
    op.drop_index('erc1155_token_transfers_token_address_id_index', table_name='erc1155_token_transfers')
    op.drop_index('erc1155_token_transfers_token_address_from_index', table_name='erc1155_token_transfers')
    op.drop_index('erc1155_token_transfers_to_address_number_log_index_index', table_name='erc1155_token_transfers')
    op.drop_index('erc1155_token_transfers_number_log_index', table_name='erc1155_token_transfers')
    op.drop_index('erc1155_token_transfers_from_address_number_log_index_index', table_name='erc1155_token_transfers')
    ...
    op.drop_index('internal_transactions_block_number_index', table_name='contract_internal_transactions')
    ...
    op.drop_index('blocks_number_unique_when_not_reorg', table_name='blocks', postgresql_where=sa.text('reorg = false'))
    op.drop_index('blocks_hash_unique_when_not_reorg', table_name='blocks', postgresql_where=sa.text('reorg = false'))
    ...
    sa.Column('latest_call_contract_time', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    ...
    sa.PrimaryKeyConstraint('token_address', 'wallet_address', 'token_id', name='erc1155_token_holders_pkey')
    )
    ...
    op.drop_index('current_token_balances_token_address_id_balance_of_index', table_name='address_current_token_balances')
    op.drop_index('current_token_balances_token_address_balance_of_index', table_name='address_current_token_balances')
