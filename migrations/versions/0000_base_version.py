...
Revision ID: 8c0b600f2158
Revises: 
Create Date: 2024-06-13 14:15:17.539509
...
def downgrade() -> None:
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('nft_campaign_id_seq'::regclass)"), autoincrement=True, nullable=False),
