...
def simple_get_rpc_requests(
    ...
    def process_batch(batch):
        parameters = build_no_input_method_data(batch, fn_name, abi_list, contract_address_key)
...
def build_no_input_method_data(requests, fn, abi_list, contract_address_key="pool_address", arguments=None):
