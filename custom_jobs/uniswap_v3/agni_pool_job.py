...
from custom_jobs.uniswap_v3.agni_abi import (
    BURN_EVENT,
...
from custom_jobs.uniswap_v3.domains.feature_uniswap_v3 import AgniV3Pool, AgniV3PoolCurrentPrice, AgniV3PoolPrice
from custom_jobs.uniswap_v3.models.feature_uniswap_v3_pools import UniswapV3Pools
from custom_jobs.uniswap_v3.util import build_no_input_method_data, simple_get_rpc_requests
...
def slot0_rpc_requests(web3, make_requests, requests, is_batch, abi_list, batch_size, max_worker):
    ...
    def process_batch(batch):
        parameters = build_no_input_method_data(batch, fn_name, abi_list)
