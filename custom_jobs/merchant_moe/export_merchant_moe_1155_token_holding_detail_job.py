...
from custom_jobs.merchant_moe.abi import (
...
from custom_jobs.merchant_moe.domains.erc1155_token_holding import (
...
from custom_jobs.merchant_moe.domains.merchant_moe import (
    MerchantMoePool,
...
from custom_jobs.merchant_moe.models.feature_merchant_moe_pool import FeatureMerchantMoePools
from custom_jobs.uniswap_v3.util import build_no_input_method_data, build_one_input_one_output_method_data
...
def batch_get_bin(web3, make_requests, requests, nft_address, is_batch, abi_list):
    ...
    parameters = build_one_input_one_output_method_data(web3, requests, nft_address, fn_name, abi_list)
...
def batch_get_pool_int(web3, make_requests, requests, is_batch, abi_list, fn_name):
    ...
    parameters = build_no_input_method_data(requests, fn_name, abi_list, "token_address")
